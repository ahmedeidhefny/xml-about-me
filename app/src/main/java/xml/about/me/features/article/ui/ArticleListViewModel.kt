...
import xml.about.me.features.article.domain.GetArticleListLocal
import xml.about.me.features.article.domain.GetArticleListRemote
    ...
    override fun getData() {
        viewModelScope.launch(Dispatchers.IO) {
            if (_currentPage > 1) {
                ...
                networkLoading(ArticleRequestTag.GetArticleList.name)
            }
