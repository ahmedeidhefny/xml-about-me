...
import xml.about.me.core.api.DefaultIfNullFactory
import xml.about.me.core.api.HeaderInterceptor
import xml.about.me.core.api.TLSSocketFactory
...
class AppModule {
    ...
    fun provideLoggingInterceptor(): HttpLoggingInterceptor {
        return HttpLoggingInterceptor().apply {
            level = if (xml.about.me.BuildConfig.DEBUG) {
    ...
    private fun okHttpClientBuilder(
        ...
        return OkHttpClient.Builder()
            ...
            .connectionPool(ConnectionPool(100,
    ...
    private fun retrofitBuilder(moshi: Moshi): Retrofit.Builder {
        return Retrofit.Builder()
            .baseUrl(xml.about.me.BuildConfig.API_URL)
